...
public class AggregateLumaMotionDetection implements IMotionDetection {
    ...
    protected boolean isDifferent(int[] first, int width, int height, int mLeniency) {
     ...
     */
    @Override
    public boolean detect(int[] luma, int width, int height, int mLeniency) {
        ...
        Log.d("MotionDetector", ""+ mLeniency);
        boolean motionDetected = isDifferent(luma, width, height, mLeniency);
